...
type (
	INegotiation interface {
		...
		SendNegotiationToProvider(ctx context.Context, data g.Map) (serviceID int64, err error)
		SendNegotiationAgreeRequest(ctx context.Context, data g.Map) (err error)
		SendNegotiationAgreeToRequestor(ctx context.Context, data g.Map) (err error)
